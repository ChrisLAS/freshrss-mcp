...
from freshrss_mcp_server.freshrss_client import FreshRSSClient, AuthenticationError
from freshrss_mcp_server.models import Article, Feed
...
def test_extract_article_id():
    ...
    client = FreshRSSClient("https://test.com", "user", "pass")
    assert client._extract_article_id(
